...
%OPENECU_GCC%powerpc-eabispe-gcc %CFG_FLAGS% -DCFG_DONT_USE_DEPRECATED @%OPENECU_TARGET%mk_cc_gcc_4_7_3.opts -I. -I%OPENECU_INC% -o engdrvs_data.o     ..\..\src\engdrvs_data.c > engdrvs_data.lst
@IF %ERRORLEVEL% NEQ 0 GOTO EndError
